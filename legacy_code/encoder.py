...
class Classifier_ENCODER:
    ...
    def build_model(self, input_shape, nb_classes):
        ...
        output_layer = keras.layers.Dense(units=nb_classes,activation='softmax',name="task_1_output")(flatten_layer)
        ...
        self.callbacks = [model_checkpoint,tensorboard]
    ...
    def fit(self, x_train, y_train, x_val, y_val, y_true):
        ...
        save_logs_stl(self.output_directory, hist, y_pred, y_true, duration, lr=False)
