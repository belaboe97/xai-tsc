...
def create_classifier_mt(classifier_name, input_shape, nb_classes_1, nb_classes_2, output_directory, gamma, verbose=False):
    ...
    if classifier_name == 'fcn_mt_sigmoid': 
        from classifiers_mtl import fcn_mt_sigmoid
        return fcn_mt_sigmoid.Classifier_FCN_MT_SIGMOID(output_directory, input_shape, nb_classes_1, gamma,EPOCHS, BATCH_SIZE, verbose)
